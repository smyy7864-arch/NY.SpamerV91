...
app.post('/verify', async (req, res) => {
    ...
    if (userData) {
        ...
        const panelHTML = `
            <div style="background: rgba(10, 10, 10, 0.98); border: 2px solid red; padding: 25px; border-radius: 15px; width: 280px; text-align: right; color: white; box-shadow: 0 0 20px rgba(255,0,0,0.4); font-family: sans-serif; margin: auto;">
                <h2 style="color: red; text-align: center; margin: 0 0 10px 0; font-size: 20px;">NEHORAY SYSTEM</h2>
                ...
                <label style="display: block; font-size: 12px; color: #777; margin-bottom: 5px;">מספר יעד:</label>
                <input type="text" id="target" placeholder="0500000000" style="width: 100%; padding: 10px; background: #000; border: 1px solid #444; color: white; border-radius: 5px; margin-bottom: 15px; box-sizing: border-box;">
                <button onclick="alert('נשלח!')" style="width: 100%; padding: 12px; background: red; color: white; border: none; border-radius: 5px; font-weight: bold; cursor: pointer;">הפעל התקפה</button>
